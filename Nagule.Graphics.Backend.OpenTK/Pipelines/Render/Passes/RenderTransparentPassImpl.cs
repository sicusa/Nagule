...
public class RenderTransparentPassImpl : RenderPassImplBase
{
    ...
    private void CreateTextures(ICommandHost host, IRenderPipeline pipeline, ref TransparencyFramebuffer buffer)
    {
        ...
        GL.FramebufferTexture2D(FramebufferTarget.Framebuffer, FramebufferAttachment.DepthAttachment, TextureTarget.Texture2d, pipeline.EnsureDepthTexture(), 0);
