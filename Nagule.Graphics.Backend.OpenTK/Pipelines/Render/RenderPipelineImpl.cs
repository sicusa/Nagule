...
public class RenderPipelineImpl : PolyHashStorage<IComponent>, IRenderPipeline
{
    ...
    public RenderPipelineImpl(uint renderSettingsId, int width, int height, IEnumerable<IRenderPass> passes)
    {
    ...
    public void Execute(ICommandHost host, uint cameraId, MeshGroup meshGroup)
    {
    ...
    public unsafe TextureHandle EnsureColorTexture()
    ...
    public unsafe TextureHandle EnsureDepthTexture()
