...
public class CompositionPipelineImpl : PolyHashStorage<IComponent>, ICompositionPipeline
{
    public IReadOnlyList<ICompositionPass> Passes => _passes;
    public uint RenderSettingsId { get; }
    ...
    private uint _id = IdFactory.New();
    private bool _initialized;
    private string _profileKey;

    private static int s_pipelineCounter;

    public CompositionPipelineImpl(uint renderSettingsId, IEnumerable<ICompositionPass> passes)
    {
    ...
    public void Execute(ICommandHost host, uint cameraId, IRenderPipeline renderPipeline)
    {
    ...
    public void Blit(ICommandHost host)
    {
