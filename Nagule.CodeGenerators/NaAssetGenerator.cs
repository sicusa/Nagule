...
{
    public virtual string AttributeName { get; } = "NaAssetAttribute";

    public string NaAssetAttributeName => $"Nagule.{AttributeName}`1";
    private string NaAssetAttributeSource => $$"""
        // <auto-generated/>
        #nullable enable
    ...
    public void Initialize(IncrementalGeneratorInitializationContext context)
    {
        context.RegisterPostInitializationOutput(context => {
            context.AddSource(AttributeName + ".g.cs",
                SourceText.From(NaAssetAttributeSource, Encoding.UTF8));
        });

        var codeGenInfos = context.SyntaxProvider.ForAttributeWithMetadataName(
            NaAssetAttributeName,
